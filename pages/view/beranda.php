...
if ($sql) {
    // Pastikan ada baris data yang dikembalikan
    if ($dt = $sql->fetch_object()) {
        echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Rp. ' . number_format($dt->total) . ' </div>';
    } else {
        // Tidak ada data yang ditemukan
        echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Belum ada penjualan hari ini</div>';
    }
} else {
    // Query tidak berhasil dieksekusi
    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Error: Query tidak dapat dieksekusi</div>';
}
?>
